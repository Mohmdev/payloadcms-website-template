...
export const AdminLogo = async () => {
  // const settingsData: Setting = await getCachedGlobal('graphics', 1)()
  // const logoUrl =
  //   settingsData.siteLogo && typeof settingsData.siteLogo === 'object' && settingsData.siteLogo.url
  //     ? settingsData.siteLogo.url
  //     : undefined

  // const logoUrl: GraphicsSelect['siteLogo'] = await getCachedGlobal('graphics', 1)()

  const loading = 'lazy'
  const priority = 'low'

  // Fallback to Payload logo if no logo is set
  // if (!logoUrl) {
  //   return (
  //     <svg
  ...
  //       width={193}
  //       height={34}
  //       className={clsx('max-w-[9.375rem] w-full h-[34px] fill-black dark:fill-white')}
