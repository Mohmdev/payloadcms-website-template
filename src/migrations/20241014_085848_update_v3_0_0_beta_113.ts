...
export async function up({ payload, req }: MigrateUpArgs): Promise<void> {
  ...
  ALTER TABLE "pages_blocks_archive" RENAME COLUMN "populateBy" TO "populate_by";
  ALTER TABLE "pages_blocks_archive" RENAME COLUMN "relationTo" TO "relation_to";
  ALTER TABLE "_pages_v_blocks_archive" RENAME COLUMN "populateBy" TO "populate_by";
  ALTER TABLE "_pages_v_blocks_archive" RENAME COLUMN "relationTo" TO "relation_to";
  ALTER TABLE "forms" RENAME COLUMN "confirmationType" TO "confirmation_type";
  DO $$ BEGIN
...
export async function down({ payload, req }: MigrateDownArgs): Promise<void> {
  ...
  ALTER TABLE "pages_blocks_archive" ADD COLUMN "populateBy" "enum_pages_blocks_archive_populate_by" DEFAULT 'collection';
  ALTER TABLE "pages_blocks_archive" ADD COLUMN "relationTo" "enum_pages_blocks_archive_relation_to" DEFAULT 'posts';
  ALTER TABLE "_pages_v_blocks_archive" ADD COLUMN "populateBy" "enum__pages_v_blocks_archive_populate_by" DEFAULT 'collection';
  ...
  ALTER TABLE "pages_blocks_archive" DROP COLUMN IF EXISTS "populate_by";
  ALTER TABLE "pages_blocks_archive" DROP COLUMN IF EXISTS "relation_to";
  ALTER TABLE "_pages_v_blocks_archive" DROP COLUMN IF EXISTS "populate_by";
  ALTER TABLE "_pages_v_blocks_archive" DROP COLUMN IF EXISTS "relation_to";
